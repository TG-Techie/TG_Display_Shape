...
disp_grp.append(shapes.roundrect(0, size, size*2, size, size//2, shapes.color(0, 255, 0)))
disp_grp.append(shapes.roundrect(0, size*2, size*2, size, size//4, shapes.color(0, 0, 255)))
disp_grp.append(shapes.hline(5, size*3 + size//2, size*3, 4, shapes.color(196,196,196)))
